...
<div id="content" style="background-image: url('/resources/img/account-background.jpeg'); background-repeat: no-repeat; background-size: 100% 100%;">
    ...
    <form:form action="${pageContext.request.contextPath}/accounts/updateLimits" modelAttribute="limits">

        Makse limiit: <form:input path="transactionLimit" />
        <br/><br/>
        Päevalimiit: <form:input path="dailyLimit" />
        <br/><br/>
        Kuulimiit: <form:input path="monthlyLimit" />
        <br/><br/>
