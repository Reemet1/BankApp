...
<div id="content" style="background-image: url('/resources/img/account-background.jpeg'); background-repeat: no-repeat; background-size: 100% 100%;">
    ...
    <table>
        ...
        <tr>
            ...
            <td>${account.accountLimits.transactionLimit}</td>
            <td>${account.accountLimits.dailyLimit}</td>
            <td>${account.accountLimits.monthlyLimit}</td>
            <td><a href="/accounts/showLimits/${account.id}">Muuda limiite</a></td>
        </tr>
